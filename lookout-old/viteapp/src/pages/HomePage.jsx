...
// Hooks from homepage
import useMounted from '@/components/homepage/hooks/useMounted';
import { useSize } from '@/components/homepage/hooks/use-size';
import { useToast } from '@/components/homepage/hooks/use-toast';
...
// Import assets
import communityImage from '@/assets/lo1/Community.jpg';
import l1Image from '@/assets/lo1/l1.png';
import l2Image from '@/assets/lo1/l2.jpg';
import l3Image from '@/assets/lo1/l3.jpg';
import l4Image from '@/assets/lo1/l4.jpg';

// Lazy load heavy components
const CardsSection = lazy(() => import('@/components/homepage/home/Cards/CardsSection'));
const HeroHeadline = lazy(() => import('@/components/homepage/home/Hero/HeroHeadline'));
const CommunitySection = lazy(() => import('@/components/community/CommunitySection'));
const Footer = lazy(() => import('@/components/community/CommunityFooter'));
const FeatureBoxes = lazy(() => import('@/components/homepage/ui/feature-boxes'));

import TESTIMONIALS from '@/components/homepage/home/Community/testimonials.data.js';
...
export default function HomePage() {
  ...
  // Images for carousel - using l1, l2, l3, l4 images
  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col relative px-4 py-8 overflow-hidden">
      ...
      <section className="section-spacing px-4 relative z-10 overflow-hidden">
        ...
        <div className="max-w-[120rem] mx-auto">
          ...
          >
            ...
            <div 
              className="text-center mb-8 relative z-10 cursor-pointer group/box" 
              ref={headlineRef}
            ...
            >
              ...
              >
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="grid place-items-center h-11 w-11 rounded-full bg-yellow-400 text-black border border-yellow-300 shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
                  aria-label="Generate"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="relative overflow-hidden rounded-full bg-yellow-400 text-black px-6 py-3 font-semibold tracking-wide border border-yellow-300 shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
                >
                  <span className="relative z-10">Generate Now</span>
                  <span
                    className="absolute inset-0 opacity-0 group-hover/box:opacity-100 transition-opacity duration-300"
                    style={{ background: 'linear-gradient(90deg, rgba(255,255,255,0.06), rgba(250,204,21,0.12))' }}
                  />
                </motion.button>
              </motion.div>
      ...
      <section className="section-spacing px-4 relative z-10 overflow-hidden">
        ...
        <div className="max-w-[120rem] mx-auto relative">
          ...
          >
            ...
            <motion.h2
              className="text-5xl md:text-6xl font-heading font-bold text-white mb-6 relative"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={{
            ...
            <motion.p
              className="text-xl font-paragraph text-white max-w-2xl mx-auto relative"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
