    ...
    >
      <nav className="container mx-auto px-3 sm:px-6 py-2.5 sm:py-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 sm:gap-4">
        ...
        <motion.div
          ...
          className="hidden sm:flex items-center rounded-full border border-white/20 bg-white/10 backdrop-blur-xl px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_8px_24px_rgba(0,0,0,0.35)] overflow-x-auto whitespace-nowrap"
          style={{ backgroundImage: 'linear-gradient(90deg, rgba(250,204,21,0.06), rgba(255,255,255,0.04))' }}
        >
          {/* Links */}
          <ul className="flex items-center gap-6 sm:gap-8 px-3 sm:px-4 text-sm sm:text-base">
            <li>
              <Link
                to="/community"
          ...
          >
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="order-1 group-hover:order-2 transition-all duration-1000 ease-[cubic-bezier(0.25,1,0.5,1)] transition-colors relative grid place-items-center h-10 w-10 sm:h-11 sm:w-11 rounded-full bg-yellow-400 text-black border border-yellow-300 shadow-[0_8px_24px_rgba(0,0,0,0.45)] group-hover:bg-black group-hover:text-white group-hover:border-white/25 group-hover:-translate-x-1.5 will-change-transform"
              aria-label="Go"
            >
              <svg
