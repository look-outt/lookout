...
import ss0904 from '@/assets/lo2/speaker session/DSC_0904.JPG';
import ss0944 from '@/assets/lo2/speaker session/DSC_0944.JPG';
import ss0972 from '@/assets/lo2/speaker session/DSC_0972.JPG';
import ss7070 from '@/assets/lo2/speaker session/DSC_7070.JPG';

function CommunitySpeakerSessions() {
  const slides = [ss0904, ss0944, ss0972, ss7070];
