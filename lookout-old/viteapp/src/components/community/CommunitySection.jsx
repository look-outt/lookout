...
import sponsorGeekRoom from '@/assets/lo2/sponsors/geek-room.png';
import sponsorGithub from '@/assets/lo2/sponsors/github.jpeg';
import sponsorHomey from '@/assets/lo2/sponsors/homey.png';
import sponsorMarketMafiaa from '@/assets/lo2/sponsors/market-mafiaa.png';
import sponsorOsata from '@/assets/lo2/sponsors/osata.jpeg';
import sponsorPathway from '@/assets/lo2/sponsors/pathway.webp';
import sponsorPhysicsWallah from '@/assets/lo2/sponsors/physics-wallah.png';
import sponsorPredator from '@/assets/lo2/sponsors/predator.png';
...
function CommunitySection() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      text: "thelinkedoutofficial@gmail.com"
    },
    {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/thelinkedout",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/linkedoutofficial",
    ...
    {
      name: "Twitter",
      href: "https://x.com/linkedout_off",
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[24px] overflow-hidden">
                <div className="relative z-10 p-8 rounded-[24px] border border-white/15 shadow-2xl bg-white/5 backdrop-blur-sm">
                <motion.h3 
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6 }}
                ...
                <div className="space-y-4">
                  {announcements.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <p className="font-semibold text-white group-hover:text-yellow-400 transition-colors duration-300 mb-2">{item.title}</p>
