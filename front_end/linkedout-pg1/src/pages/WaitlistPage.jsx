      ...
      <div className="flex justify-center gap-6 mt-8 mb-2">
        ...
        {/* LinkedIn */}
        <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="bg-black/60 border border-yellow-700 rounded-xl p-3 text-white hover:text-yellow-400 transition-colors backdrop-blur-md flex items-center justify-center shadow-lg">
...
export default function WaitlistPage() {
  ...
  <div className="flex justify-center gap-3 mt-3 mb-2">
    {/* LinkedIn */}
    <a href="https://www.linkedin.com/company/thelinkedout/" target="_blank" rel="noopener noreferrer" className="border border-[#FFD966] rounded-lg p-2 text-[#FFD966] hover:bg-[#FFD966]/60 hover:text-black transition-colors flex items-center justify-center backdrop-blur-md shadow bg-black/30" style={{opacity:0.85}}>
    ...
    {/* Instagram */}
    <a href="https://www.instagram.com/linkedoutofficial?igsh=MXQ0b3h6dWgxYXN6eA==" target="_blank" rel="noopener noreferrer" className="border border-[#FFD966] rounded-lg p-2 text-[#FFD966] hover:bg-[#FFD966]/60 hover:text-black transition-colors flex items-center justify-center backdrop-blur-md shadow bg-black/30" style={{opacity:0.85}}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5A4.25 4.25 0 0 0 20.5 16.25v-8.5A4.25 4.25 0 0 0 16.25 3.5h-8.5zm4.25 3.25a5.25 5.25 0 1 1 0 10.5a5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5a3.75 3.75 0 0 0 0-7.5zm5.25.75a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0z" />
      </svg>
    </a>
    {/* Twitter (X) */}
    <a href="https://x.com/linkedout_off" target="_blank" rel="noopener noreferrer" className="border border-[#FFD966] rounded-lg p-2 text-[#FFD966] hover:bg-[#FFD966]/60 hover:text-black transition-colors flex items-center justify-center backdrop-blur-md shadow bg-black/30" style={{opacity:0.85}}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M17.53 3H21L14.19 10.39L22.09 21H15.66L10.87 14.67L5.56 21H2L9.13 13.03L1.61 3H8.18L12.54 8.72L17.53 3ZM16.34 19H18.14L7.82 5H6.01L16.34 19Z" />
      </svg>
    </a>
