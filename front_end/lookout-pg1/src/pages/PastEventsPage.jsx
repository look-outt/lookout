...
const events = [
  {
    title: 'LookOut Live #1',
    venue: 'Thoughtworks, Gurugram',
    links: [
      { label: 'Official Social Media post', href: '#' },
      { label: 'Post-event YouTube video', href: '#' },
    ],
    images: ['/lo2/past events/DSC_0684.JPG',
            '/lo2/past events/DSC_0804.JPG', 
            '/lo2/past events/DSC_0906.JPG',
            '/lo2/past events/DSC_0959-EDIT.jpg'],
  },
  {
    title: 'LookOut Live #2',
    ...
    <div className="min-h-screen text-white bg-black relative">
      ...
      <main className="container mx-auto px-4 pt-24 pb-24">
        ...
        >
          ...
          >
            <span className="text-yellow-400">LookOut</span>{' '}
          ...
          >
            Discover the highlights from our incredible journey of connecting social media creators worldwide through engaging events and transformative sessions.
          </motion.p>
        </motion.header>
