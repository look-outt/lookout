...
function WritePostPage() {
  ...
  const availableTags = [
    'Social Media Tips', 'Content Creation', 'Personal Branding', 'Networking',
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
              Share your insights with the LookOut community and help fellow creators grow.
            </p>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-bold mb-6 text-yellow-400">
              💡 Writing Tips for Social Media Success
            </h3>
