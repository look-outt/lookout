        ...
        >
          <div onClick={handleLogoClick} className="flex items-center gap-3 cursor-pointer group">
            <img
              src="/logo full.png"
              alt="Logo"
              className="h-12 w-auto object-contain transition-all duration-300 group-hover:drop-shadow-[0_0_20px_rgba(250,204,21,0.5)]"
            />
            <span className="text-2xl font-bold text-white group-hover:text-yellow-400 transition-colors tracking-wide">LookOut</span>
          </div>
        </motion.div>
          ...
          >
            ...
            {user ? (
              ...
              <div className="flex items-center gap-3">
                <Link
                  to="/create"
                  className="text-gray-200/90 hover:text-yellow-400 font-medium transition-colors"
                >
                  Dashboard
                </Link>
                <button
                  onClick={handleLogout}
                  className="rounded-full border border-white/25 bg-white/10 px-4 py-2 text-sm font-semibold text-white hover:bg-yellow-400 hover:text-black transition-colors"
                >
                  Log out
                </button>
              </div>
              ...
              <>
                <Link
                  to="/login"
                  className="text-gray-200/90 hover:text-white font-medium transition-colors px-2"
                >
                  Log In
                </Link>
                <motion.a
              ...
              <div className="mt-4 flex flex-col gap-3">
                {user ? (
                  <>
                    <Link
                      to="/create"
                      className="w-full rounded-full border border-white/25 bg-white/10 py-3 text-center font-semibold text-white transition-colors hover:bg-yellow-400 hover:text-black"
                      onClick={() => setIsMenuOpen(false)}
                    >
                      Dashboard
                    </Link>
                    <button
                      ...
                      className="w-full rounded-full border border-red-500/40 bg-red-500/10 py-3 text-center font-semibold text-red-400 transition-colors hover:bg-red-500 hover:text-white"
                    >
                      Log out
                    </button>
                  </>
                  ...
                  <>
                    <Link
                      to="/login"
                      className="w-full rounded-full border border-white/25 bg-white/10 py-3 text-center font-semibold text-white transition-colors hover:bg-white/20"
                      onClick={() => setIsMenuOpen(false)}
                    >
                      Log In
                    </Link>
