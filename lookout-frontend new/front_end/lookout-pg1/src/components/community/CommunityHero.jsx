      ...
      <div className="relative z-10 mx-auto flex min-h-[70vh] max-w-7xl flex-col gap-12 px-4 pb-16 sm:px-6 lg:flex-row lg:items-center lg:gap-16 lg:pb-24">
        ...
        >
          ...
          >
            ...
            The home for social media creators
          </motion.div>
          ...
          >
            World's largest community for <span className="font-semibold text-yellow-400">social media creators</span>
          </motion.p>
