      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-16">
          ...
          >
            ...
            >
              Discover the highlights from our incredible journey of connecting social media creators worldwide through engaging events and sessions.
            </motion.p>
